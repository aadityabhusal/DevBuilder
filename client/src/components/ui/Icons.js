...
export function ElementsIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="#7f8c8d" width="24px" height="24px">
...
export function PagesIcon() {
  return (
    <svg height="24" fill="#7f8c8d" viewBox="0 0 24 24" width="24">
      <path d="M0 0h24v24H0z" fill="none" />
...
export function PropertiesIcon() {
  return (
    <svg height="24" viewBox="0 0 24 24" fill="#7f8c8d" width="24">
      <path d="M0 0h24v24H0z" fill="none" />
